...
public class ViewPersonJPanel extends javax.swing.JPanel 
{
    ...
    SystemClass system;
    public ViewPersonJPanel(SystemClass system) 
    {
        initComponents();
        this.system = system;
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnAddP, javax.swing.GroupLayout.PREFERRED_SIZE, 117, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(97, 97, 97)))
                .addGap(48, 48, 48))
        );
    ...
    private void btnAddPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddPActionPerformed
     ...
     private void populate()
     {
        DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
        model.setRowCount(0);
        for (PersonClass v : system.getListOfPersons().getPersons()) 
        {

            Period period = Period.between(v.getDOB().atZone(ZoneId.systemDefault()).toLocalDate(), LocalDate.now());

            Object[] row = new Object[6];
            row[0] = v.getID();
            row[1] = v.getName();
            row[3] = v.getAddress().getAddress();
            row[4] = v.getAddress().getCommunity().getCommunity();
